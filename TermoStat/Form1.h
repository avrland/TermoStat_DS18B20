...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			chartArea2->AxisX->LabelStyle->Format = L"d.M.20y";
			chartArea2->AxisX->LabelStyle->Interval = 24;
			...
			chartArea2->AxisX2->Interval = 1;
			chartArea2->AxisX2->IntervalAutoMode = System::Windows::Forms::DataVisualization::Charting::IntervalAutoMode::VariableCount;
			chartArea2->AxisX2->IntervalOffset = 1;
			chartArea2->AxisX2->IntervalOffsetType = System::Windows::Forms::DataVisualization::Charting::DateTimeIntervalType::Days;
			...
			chartArea2->AxisX2->LabelStyle->Format = L"D.M";
			chartArea2->AxisX2->LabelStyle->Interval = 1;
			chartArea2->AxisX2->LabelStyle->IntervalOffset = 1;
			chartArea2->AxisX2->LabelStyle->IntervalOffsetType = System::Windows::Forms::DataVisualization::Charting::DateTimeIntervalType::Days;
			chartArea2->AxisX2->LabelStyle->IntervalType = System::Windows::Forms::DataVisualization::Charting::DateTimeIntervalType::Days;
			chartArea2->AxisX2->LabelStyle->IsEndLabelVisible = false;
			chartArea2->CursorX->Interval = 12;
			...
			chartArea2->CursorY->IntervalOffsetType = System::Windows::Forms::DataVisualization::Charting::DateTimeIntervalType::Hours;
			chartArea2->CursorY->IntervalType = System::Windows::Forms::DataVisualization::Charting::DateTimeIntervalType::Hours;
			...
			series2->EmptyPointStyle->Label = L"Brak danych.";
			series2->EmptyPointStyle->Name = L"Brak danych.";
			...
			this->textBox1->Text = L"http://vps.avrland.ovh/temp.log";
			// 
			// button2
			// 
